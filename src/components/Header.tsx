...
import { Mountain, Award, Map, UserPlus, Settings, Database, Menu, X } from 'lucide-react';
import { LanguageSelector } from './LanguageSelector';
import { Translation } from '../i18n/translations';

interface HeaderProps {
  activeTab: 'passes' | 'map' | 'stats' | 'register' | 'admin' | 'database';
  onTabChange: (tab: 'passes' | 'map' | 'stats' | 'register' | 'admin' | 'database') => void;
