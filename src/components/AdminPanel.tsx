            ...
            {newCollaborator.images.length > 0 && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                          placeholder="Ej: Estados Unidos, Italia..."
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setEditingBrand({ ...editingBrand, foundedYear: e.target.value ? parseInt(e.target.value) : undefined })}
                          className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                          placeholder="Ej: 1976"
                          min="1800"
                          max={new Date().getFullYear()}
                  ...
                  {newCollaborator.images.map((image, index) => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {(editingBrand.specialties || []).map((specialty, index) => (
                          <div key={index} className="flex items-center space-x-2">
                            <input
                              type="text"
                              value={specialty}
                              onChange={(e) => {
                                const newSpecialties = [...(editingBrand.specialties || [])];
                                newSpecialties[index] = e.target.value;
                                setEditingBrand({ ...editingBrand, specialties: newSpecialties });
                              }}
                              className="flex-1 px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                              placeholder="Ej: Bicicletas de carretera"
                            />
                            <button
                              type="button"
                              onClick={() => {
                                const newSpecialties = (editingBrand.specialties || []).filter((_, i) => i !== index);
                                setEditingBrand({ ...editingBrand, specialties: newSpecialties });
                              }}
                        ...
                        <button
                          ...
                          className="flex items-center space-x-2 px-3 py-2 border border-dashed border-slate-300 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-colors text-sm"
                        >
                          <Plus className="h-4 w-4" />
