        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold text-gray-900">Compartir</h3>
              <button
                onClick={() => setShowModal(false)}
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors border border-gray-200 w-full"
              >
                ...
                <span className="font-medium text-gray-900">Copiar enlace</span>
              </button>
            </div>
          </div>
        </div>
